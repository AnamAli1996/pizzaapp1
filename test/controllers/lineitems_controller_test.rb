...
class LineitemsControllerTest < ActionController::TestCase
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post :create, lineitem: { cart_id: @lineitem.cart_id, order_id: @lineitem.order_id, pizza_id: @lineitem.pizza_id, quantity: @lineitem.quantity }
    end
  ...
  test "should update lineitem" do
    patch :update, id: @lineitem, lineitem: { cart_id: @lineitem.cart_id, order_id: @lineitem.order_id, pizza_id: @lineitem.pizza_id, quantity: @lineitem.quantity }
    assert_redirected_to lineitem_path(assigns(:lineitem))
  end
